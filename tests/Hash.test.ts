...
describe('Hash', () =>
{
    ...
    it('Test of reading and writing hex string', () => {
        ...
        let h = new crypto.Hash('0x5d7f6a7a30f7ff591c8649f61eb8a35d034824ed5cd252c2c6f10cdbd223671' +
    ...
    it('Test of hash("abc")', () => {
        // Hash
        let h = crypto.hash(Buffer.from("abc"));
    ...
    it('Test of multi hash', () => {
        // Source 1 : "foo"
        let foo = crypto.hash(Buffer.from("foo"));

        // Source 2 : "bar"
        let bar = crypto.hash(Buffer.from("bar"));

        // Hash Multi
        let h = crypto.hashMulti(foo.data, bar.data);
    ...
    it('Test of utxo key, using makeUTXOKey', () => {
        let tx_hash = new crypto.Hash('0x5d7f6a7a30f7ff591c8649f61eb8a35d034824ed5cd252c2c6f10cdbd223671' +
            '3dc369ef2a44b62ba113814a9d819a276ff61582874c9aee9c98efa2aa1f10d73');
        let hash = crypto.makeUTXOKey(tx_hash, JSBI.BigInt(1));
