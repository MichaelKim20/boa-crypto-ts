...
export function crypto_core_ed25519_is_valid_scalar (x: Uint8Array): boolean
{
    ...
    return !((ref10.sc25519_is_canonical(x) == 0) || (sodium_is_zero(x, crypto_core_ed25519_SCALARBYTES) != 0));
}
...
export function crypto_core_ed25519_is_valid_random_scalar (r: Uint8Array): boolean
{
    ...
    return !((ref10.sc25519_is_canonical(t) == 0) || (sodium_is_zero(t, crypto_core_ed25519_SCALARBYTES) != 0));
}
